"""
URL configuration for merkat project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="MerkatApp API",
        default_version='v1',
        description="API documentation for MerkatApp",
...
if settings.DEBUG:  
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) # dodato
